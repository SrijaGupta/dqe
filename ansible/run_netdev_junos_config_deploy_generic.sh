...
ANSIBLE_PLAYBOOK=netdev_junos_config_deploy_generic.yml
...
INVENTORY_DEVICE_GROUP_NAME="cluster_fabric_${DEVICE_ROLE_NAME}_devices"
INVENTORY_DEVICE_GROUP_NAME="${DEVICE_GROUP_NAME}"
# INVENTORY_DEVICE_GROUP_NAME="cluster_fabric_mx_devices"
...
ansible-playbook ${ANSIBLE_DEBUG} \
	...
	-l "localhost,${INVENTORY_DEVICE_GROUP_NAME}" \
...
echo "DEVICE_ROLE_NAME            : $DEVICE_ROLE_NAME"
